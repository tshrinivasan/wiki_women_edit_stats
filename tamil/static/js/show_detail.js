$(function(){
	...
	var ajax_call = function(){
		...
		.done(function( data ) {
			...
			var articleTotal = addData(articles,'#articleData','https://ta.wikipedia.org/wiki/',articleTable);
			var participantTotal = addData(participants,'#userData','https://ta.wikipedia.org/wiki/Special:Contributions/',userTable);
