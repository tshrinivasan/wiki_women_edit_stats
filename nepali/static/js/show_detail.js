$(function(){
	...
	var ajax_call = function(){
		...
		.done(function( data ) {
			...
			var articleTotal = addData(articles,'#articleData','https://ne.wikipedia.org/wiki/',articleTable);
			var participantTotal = addData(participants,'#userData','https://ne.wikipedia.org/wiki/Special:Contributions/',userTable);
