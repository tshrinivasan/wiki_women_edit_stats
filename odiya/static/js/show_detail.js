$(function(){
	...
	var ajax_call = function(){
		...
		.done(function( data ) {
			...
			var articleTotal = addData(articles,'#articleData','https://or.wikipedia.org/wiki/',articleTable);
			var participantTotal = addData(participants,'#userData','https://or.wikipedia.org/wiki/Special:Contributions/',userTable);
