$(function(){
	...
	var ajax_call = function(){
		...
		.done(function( data ) {
			...
			var articleTotal = addData(articles,'#articleData','https://bn.wikipedia.org/wiki/',articleTable);
			var participantTotal = addData(participants,'#userData','https://bn.wikipedia.org/wiki/Special:Contributions/',userTable);
